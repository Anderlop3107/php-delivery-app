                                ...
                                <div style="display:flex; align-items:center; gap:12px;">
                                    <div class="doc-mini-preview" style="width: 40px; height: 30px; border-radius: 6px; overflow: hidden; background: #e2e8f0; border: 1px solid #cbd5e1; display: flex; align-items: center; justify-content: center;">
                                        <?php if ($driverData['doc_ci_path']): ?>
                                            <img src="<?= esc(protected_file_url($driverData['doc_ci_path'])) ?>" style="width:100%; height:100%; object-fit:cover;">
                                        <?php else: ?>
                                ...
                                <div style="display:flex; align-items:center; gap:12px;">
                                    <div class="doc-mini-preview" style="width: 40px; height: 30px; border-radius: 6px; overflow: hidden; background: #e2e8f0; border: 1px solid #cbd5e1; display: flex; align-items: center; justify-content: center;">
                                        <?php if ($driverData['doc_licencia_path']): ?>
                                            <img src="<?= esc(protected_file_url($driverData['doc_licencia_path'])) ?>" style="width:100%; height:100%; object-fit:cover;">
                                        <?php else: ?>
                                            <span style="font-size:12px;">🪪</span>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div style="display:flex; align-items:center; gap:12px;">
                                    <div class="doc-mini-preview" style="width: 40px; height: 30px; border-radius: 6px; overflow: hidden; background: #e2e8f0; border: 1px solid #cbd5e1; display: flex; align-items: center; justify-content: center;">
                                        <?php if ($driverData['doc_habilitacion_path']): ?>
                                            <img src="<?= esc(protected_file_url($driverData['doc_habilitacion_path'])) ?>" style="width:100%; height:100%; object-fit:cover;">
                                        <?php else: ?>
                                            <span style="font-size:12px;">🚗</span>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div style="display:flex; align-items:center; gap:12px;">
                                    <div class="doc-mini-preview" style="width: 40px; height: 30px; border-radius: 6px; overflow: hidden; background: #e2e8f0; border: 1px solid #cbd5e1; display: flex; align-items: center; justify-content: center;">
                                        <?php if ($driverData['doc_cedula_verde_path']): ?>
                                            <img src="<?= esc(protected_file_url($driverData['doc_cedula_verde_path'])) ?>" style="width:100%; height:100%; object-fit:cover;">
                                        <?php else: ?>
                                            <span style="font-size:12px;">💚</span>
                                        <?php endif; ?>
                                    </div>
            ...
            confirmDeleteActBtn.onclick = function() {
                ...
                .then(res => {
                    if (res.success) {
                        ...
                        showSuccessModal('¡Repartidor Eliminado! 🗑️', res.message);
                        setTimeout(() => { window.location.href = 'admin_dashboard.php'; }, 1200);
                    } else {
