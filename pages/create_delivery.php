...
<style>
    ...
    .cost-trip-card span { font-size: 11px; font-weight: 700; opacity: 0.9; }
    .cost-trip-card b { font-size: 18px; font-weight: 900; }
    ...
    <div class="form-step" id="step-2">
        <div class="summary-card">
            ...
            <div style="margin-bottom: 12px;">
                <h3 id="v-local-name" style="margin:0; font-size:20px; color:var(--primary);"><?= esc($localData['business_name'] ?: 'Local') ?></h3>
            </div>

            <!-- 2. Cliente -->
            <div style="margin-bottom: 15px;">
                <p id="v-customer-name" style="margin:0; font-size:16px; font-weight:700; color:var(--text);">-</p>
            </div>
            ...
            <div class="contact-row" style="margin-bottom: 15px; display: flex; align-items: center; gap: 10px;">
                ...
                <div style="display: flex; align-items: center; gap: 5px; color: #64748b; font-size: 13px; font-weight: 600;">
            ...
            <div style="margin-bottom: 12px;">
                ...
                <p id="v-ref" style="margin:4px 0 0; font-size:14px; color:var(--text); font-weight:600;">-</p>
            </div>

            <!-- 5. Dirección -->
            <div>
                <span style="font-size:11px; font-weight:800; color:#94a3b8; text-transform:uppercase;">Dirección</span>
                <p id="v-address" style="margin:4px 0 0; font-size:14px; color:var(--text); font-weight:600;">-</p>
            </div>
        </div>
        ...
        <div class="cost-trip-card">
            <div style="display:flex; flex-direction:column;">
                ...
                <b>Gs. <span id="v-total-trip">0</span></b>
            </div>
