...
<style>
    ...
    .gps-link-btn { 
        background: transparent; color: var(--primary, #2563eb); width: 48px; height: 48px; border-radius: 50%; 
        display: flex; align-items: center; justify-content: center; text-decoration: none; 
        ...
        <div class="driver-profile-header">
            ...
            <div class="driver-contact-capsule">
                <a id="t-header-gps-btn" href="#" target="_blank" class="gps-link-btn" title="Abrir ubicación en Google Maps GPS">
                    <svg style="width:30px; height:30px; color:var(--primary, #2563eb);" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
