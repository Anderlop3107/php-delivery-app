...
<div id="tracking-sheet-modal" class="tracking-modal-overlay" style="display: none;">
    ...
    <div class="tracking-bottom-sheet">
        ...
        <!-- CÁPSULA DE CONTACTO (PARTE INFERIOR) -->
        <div class="driver-contact-capsule" style="display: flex; justify-content: flex-end; gap: 8px; margin-top: 12px; padding-top: 12px; border-top: 1px dashed rgba(0, 0, 0, 0.08);">
